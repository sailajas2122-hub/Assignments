...
public class DataTypes {
	...
	public static void main(String[] args) {
		...
		float temp = 25.5f;
		System.out.println("Tempareture of City:"+temp);
		...
		String phnumber = "123-456-7890";
		System.out.println("Person's PhoneNumber:"+phnumber);
		...
		String Colour = "Blue";
		System.out.println("person's favouritte colour:" +Colour);
